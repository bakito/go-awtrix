...
// Code generated from client/types/settings.go

package types

//go:generate go run github.com/kilianpaquier/go-builder-generator/cmd/go-builder-generator@latest generate -d . -f settings.go -s Settings
